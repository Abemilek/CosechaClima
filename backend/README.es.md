...
> [!NOTE]
> El archivo `compose.yaml` y `.env.example` estan en la raiz del monorepo, no dentro de `/backend`. Ver la [documentacion raiz](../README.es.md) para el quickstart global.
